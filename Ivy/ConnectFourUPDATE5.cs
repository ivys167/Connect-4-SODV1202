...
namespace ConnectFour
{
    ...
    public class HumanPlayer : Player
    {
        ...
        public override void PlaceChip(int column, ref Game game, Player humanPlayer)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                if (gameBoardForCheck.cells[column, 5].ChipInCell == false)
                {
    ...
    public class AIPlayer : Player
    {
        ...
        public int DetermineBestColumn(Game game, Player AIPlayer, Player humanPlayer)
        {
            ...
            if (game.Turn == 2)
            {
                return rnd.Next(1, 8);     // if it is the first turn, place the chip in a random column
            }
            else
            {
                int bestColumn = -1;
            ...
            do
            {
                ...
                if (connectFour.CurrentPlayer == playerX)
                {
                    ...
                    while (nonvalidInputFlag)
                    {
                        ...
                        if (connectFour.GameBoard.cells[selectedColumn, 7].ChipInCell == true)
                ...
                if (connectFour.CurrentPlayer == playerO)
                {
