...
namespace ConnectFour
{
    public class Game
    {
        ...
        public bool CheckWinner(Player currentPlayer)     // ignore the error, function is under construction
        {
            // Check for a winner
            // Vertical check
            for (int i = 0; i < 7; i++)
    ...
    public abstract class Player
    {
        ...
        // Methods
        public virtual void PlaceChip(int column, Game game)
        {
    ...
    public class HumanPlayer : Player
    {
        ...
        // Methods
        public override void PlaceChip(int column, Game game)
        {
